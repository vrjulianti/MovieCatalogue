...
public class FragmentNow extends Fragment
{
    ...
    private NowplayAdapter moviesAdapter;
    Call call   ;
    ...
    {
        v = inflater.inflate(R.layout.fragment_nowplaying, container, false);
        init_widget();
        getData();
        return  v;
    }
    ...
    private void init_widget()
    {
        ...
        moviesAdapter = new NowplayAdapter(getContext(), movieList);
    ...
    public void getData()
    {
        ...
        call = movieApiService.getNowPlaying(BuildConfig.ApiKey, currentPage, "US");
