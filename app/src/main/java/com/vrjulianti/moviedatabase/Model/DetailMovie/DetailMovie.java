...
import static com.vrjulianti.moviedatabase.Database.MovieContractBuilder.getColumnDouble;
import static com.vrjulianti.moviedatabase.Database.MovieContractBuilder.getColumnInt;
import static com.vrjulianti.moviedatabase.Database.MovieContractBuilder.getColumnString;
...
public class DetailMovie implements Parcelable, Serializable
{
    ...
    public DetailMovie(Cursor cursor) {
        this.id = getColumnInt(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_ID);
        this.title = getColumnString(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_TITLE);
        this.overview = getColumnString(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_OVERVIEW);
        this.voteCount = getColumnInt(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_VOTE_COUNT);
        this.voteAverage = getColumnDouble(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_VOTE_AVERAGE);
        this.releaseDate = getColumnString(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_RELEASE_DATE);
        this.posterPath = getColumnString(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_POSTER_PATH);
        this.backdropPath = getColumnString(cursor, MovieContractBuilder.MovieColumns.COLUMN_MOVIE_BACKDROP_PATH);
    }
    @Override
